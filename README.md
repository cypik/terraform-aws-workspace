...
| <a name="output_workspace_ids"></a> [workspace\_ids](#output\_workspace\_ids) | The IDs of the created WorkSpaces |
| <a name="output_workspace_user_names"></a> [workspace\_user\_names](#output\_workspace\_user\_names) | The user names associated with the created WorkSpaces |
